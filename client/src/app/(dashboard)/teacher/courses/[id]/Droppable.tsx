...
const DroppableComponent = () => {
    ...
    const handleSectionDragEnd = (result: any) => {
        ...
        const [ reordedSection ] = updatedSections.splice(startIndex, 1);
        updatedSections.splice(endIndex, 0, reordedSection);
    ...
    const handleChapterDragEnd = (result: any, sectionIndex: number) => {
        ...
        const [ reordedChapter ] = updatedChapters.splice(startIndex, 1);
        updatedChapters.splice(endIndex, 0, reordedChapter);
                            ...
                            {(draggableProvided) => (
                                ...
                                >
                                    ...
                                    <Button
                                        ...
                                        variant='outline'
                                        size='sm'
                                        onClick={() => dispatch(openChapterModal({ sectionIndex, chapterIndex: null }))}
