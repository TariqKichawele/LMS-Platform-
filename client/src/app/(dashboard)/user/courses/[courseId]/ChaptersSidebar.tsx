...
const ChaptersSidebar = () => {
    ...
    if (!course || !userProgress) return <div>Course not found</div>
  ...
  return (
    <div ref={sidebarRef} className='chapters-sidebar'>
        <div className='chapters-sidebar__header'>
            <h2 className='chapters-sideber__title'>{course.title}</h2>
...
const Section = ({
    ...
    const completedChapters = sectionProgress?.chapters.filter((chapter: any) => chapter.completed).length || 0; 
...
const Chapter = ({
    ...
    const isCurrentChapter = chapter.chapterId === chapterId;
